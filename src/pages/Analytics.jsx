...
//         {/* Header */}
//         <header className="bg-gradient-to-r from-blue-600 to-sky-500 rounded-2xl px-5 py-4 md:px-7 md:py-5 shadow-sm text-white flex flex-col md:flex-row md:items-center md:justify-between gap-5 m-4">
//           <div>
...
//                     : "bg-blue-500/40 text-white border-blue-200/40 hover:bg-blue-400/80")
//                 }
//                 onClick={() => setRange("7d")}
//               >
//                 Last 7 days
